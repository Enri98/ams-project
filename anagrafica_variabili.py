...
vars_transcode = {
    ...
    'prtvtxx': 'Party voted for in last national election, [country]',
    'prtvxx1': 'Party voted for in last national election 1, [country]',
    'prtvxx2': 'Party voted for in last national election 2, [country]',
    'prtvtebe': 'Party voted for in last national election, Belgium',
    'prtvtebg': 'Party voted for in last national election, Bulgaria',
    'prtvthch': 'Party voted for in last national election, Switzerland',
    ...
    'prtvtdgr': 'Party voted for in last national election, Greece',
    'prtvtghu': 'Party voted for in last national election, Hungary',
    'prtvtdis': 'Party voted for in last national election, Iceland',
    'prtvtdie': 'Party voted for in last national election, Ireland (derived from 1st preference vote)',
    ...
    'prtvtame': 'Party voted for in last national election, Montenegro',
    'prtvthnl': 'Party voted for in last national election, Netherlands',
    'prtvtmk': 'Party voted for in last national election, North Macedonia',
    'prtvtbno': 'Party voted for in last national election, Norway',
    'prtvtdpt': 'Party voted for in last national election, Portugal',
    'prtvtfsi': 'Party voted for in last national election, Slovenia',
    'prtvtesk': 'Party voted for in last national election, Slovakia',
    'prtvtdgb': 'Party voted for in last national election, United Kingdom',
    ...
    'prtclxx': 'Which party feel closer to, [country]',
    'prtclebe': 'Which party feel closer to, Belgium',
    'prtclebg': 'Which party feel closer to, Bulgaria',
    'prtclhch': 'Which party feel closer to, Switzerland',
    ...
    'prtcldgr': 'Which party feel closer to, Greece',
    'prtclhhu': 'Which party feel closer to, Hungary',
    'prtcldis': 'Which party feel closer to, Iceland',
    'prtclfie': 'Which party feel closer to, Ireland',
    'prtcleit': 'Which party feel closer to, Italy',
    'prtclclt': 'Which party feel closer to, Lithuania',
    'prtclame': 'Which party feel closer to, Montenegro',
    'prtclgnl': 'Which party feel closer to, Netherlands',
    'prtclmk': 'Which party feel closer to, North Macedonia',
    'prtclbno': 'Which party feel closer to, Norway',
    'prtclfpt': 'Which party feel closer to, Portugal',
    'prtclfsi': 'Which party feel closer to, Slovenia',
    'prtclesk': 'Which party feel closer to, Slovakia',
    'prtcldgb': 'Which party feel closer to, United Kingdom',
    ...
    'rlgdnxx': 'Religion or denomination belonging to at present, [country]',
    ...
    'rlgdnais': 'Religion or denomination belonging to at present, Iceland',
    ...
    'rlgdme': 'Religion or denomination belonging to at present, Montenegro',
    'rlgdnanl': 'Religion or denomination belonging to at present, Netherlands',
    'rlgdnmk': 'Religion or denomination belonging to at present, North Macedonia',
    ...
    'rlgdexx': 'Religion or denomination belonging to in the past, [country]',
    ...
    'rlgdeais': 'Religion or denomination belonging to in the past, Iceland',
    ...
    'rlgdeme': 'Religion or denomination belonging to in the past, Montenegro',
    'rlgdeanl': 'Religion or denomination belonging to in the past, Netherlands',
    'rlgdemk': 'Religion or denomination belonging to in the past, North Macedonia',
    ...
    'rshpsmk': 'Relationship with husband/wife/partner currently living with, North Macedonia',
    'rshpsgb': 'Relationship with husband/wife/partner currently living with, United Kingdom',
    ...
    'marstmk': 'Legal marital status, North Macedonia',
    ...
    'edlvdxx': 'Highest level of education, [country]',
    'edlvebe': 'Highest level of education, Belgium',
    ...
    'edlvegr': 'Highest level of education, Greece',
    'edlvdahu': 'Highest level of education, Hungary',
    'edlvdis': 'Highest level of education, Iceland',
    ...
    'edlvdme': 'Highest level of education, Montenegro',
    'edlvenl': 'Highest level of education, Netherlands',
    'edlvdmk': 'Highest level of education, North Macedonia',
    'edlveno': 'Highest level of education, Norway',
    'edlvdpt': 'Highest level of education, Portugal',
    'edlvesi': 'Highest level of education, Slovenia',
    'edlvdsk': 'Highest level of education, Slovakia',
    'educgb1': 'Highest level of education, United Kingdom: Up to 2 or more A-levels or equivalent',
    ...
    'edlvpdxx': 'Partner\'s highest level of education, [country]',
    'edlvpebe': 'Partner\'s highest level of education, Belgium',
    ...
    'edlvpegr': 'Partner\'s highest level of education, Greece',
    'edlvpdahu': 'Partner\'s highest level of education, Hungary',
    'edlvpdis': 'Partner\'s highest level of education, Iceland',
    ...
    'edlvpdme': 'Partner\'s highest level of education, Montenegro',
    'edlvpenl': 'Partner\'s highest level of education, Netherlands',
    'edlvpdmk': 'Partner\'s highest level of education, North Macedonia',
    'edlvpeno': 'Partner\'s highest level of education, Norway',
    'edlvpdpt': 'Partner\'s highest level of education, Portugal',
    'edlvpesi': 'Partner\'s highest level of education, Slovenia',
    'edlvpdsk': 'Partner\'s highest level of education, Slovakia',
    'edupcgb1': 'Partner\'s highest level of education, United Kingdom: Up to 2 or more A-levels or equivalent',
    'edupbgb2': 'Partner\'s highest level of education, United Kingdom: Up to Ph.D or equivalent',
    ...
    'edlvfdxx': 'Father\'s highest level of education, [country]',
    'edlvfebe': 'Father\'s highest level of education, Belgium',
    ...
    'edlvfegr': 'Father\'s highest level of education, Greece',
    'edlvfdahu': 'Father\'s highest level of education, Hungary',
    'edlvfdis': 'Father\'s highest level of education, Iceland',
    ...
    'edlvfdme': 'Father\'s highest level of education, Montenegro',
    'edlvfenl': 'Father\'s highest level of education, Netherlands',
    'edlvfdmk': 'Father\'s highest level of education, North Macedonia',
    'edlvfeno': 'Father\'s highest level of education, Norway',
    'edlvfdpt': 'Father\'s highest level of education, Portugal',
    'edlvfesi': 'Father\'s highest level of education, Slovenia',
    'edlvfdsk': 'Father\'s highest level of education, Slovakia',
    'edufcgb1': 'Father\'s highest level of education, United Kingdom: Up to 2 or more A-levels or equivalent',
    ...
    'edlvmdxx': 'Mother\'s highest level of education, [country]',
    'edlvmebe': 'Mother\'s highest level of education, Belgium',
    ...
    'edlvmegr': 'Mother\'s highest level of education, Greece',
    'edlvmdahu': 'Mother\'s highest level of education, Hungary',
    'edlvmdis': 'Mother\'s highest level of education, Iceland',
    ...
    'edlvmdme': 'Mother\'s highest level of education, Montenegro',
    'edlvmenl': 'Mother\'s highest level of education, Netherlands',
    'edlvmdmk': 'Mother\'s highest level of education, North Macedonia',
    'edlvmeno': 'Mother\'s highest level of education, Norway',
    'edlvmdpt': 'Mother\'s highest level of education, Portugal',
    'edlvmesi': 'Mother\'s highest level of education, Slovenia',
    'edlvmdsk': 'Mother\'s highest level of education, Slovakia',
    'edumcgb1': 'Mother\'s highest level of education, United Kingdom: Up to 2 or more A-levels or equivalent',
    ...
    'anc1xx': 'First ancestry, [country]',
    'anc2xx': 'Second ancestry, [country]',
    ...
    'manphone': 'Speak with line manager about work using a phone, how often',
    ...
    'panmonpb': 'More important for governments to monitor the public or to maintain public privacy when fighting a pandemic',
    'govpriph': 'More important for governments to prioritise public health or economic activity',
    'govmonpb': 'More important for governments to monitor the public or to maintain public privacy',
    'panfolru': 'More important to follow government rules or make own decisions when fighting a pandemic',
    'panclobo': 'How important for country to close its borders when fighting a pandemic',
    'panresmo': 'How important to restrict people\'s movement within parts of country when fighting a pandemic',
    'gvhanc19': 'How satisfied with government\'s handling of COVID-19 in country',
    'gvjobc19': 'How satisfied with government\'s response to those who have experienced job/income losses',
    ...
    'hscopc19': 'How satisfied with the way health services handled COVID-19 and its consequences in country',
    'gvbalc19': 'How the government balanced protecting the economy and public health when responding to COVID-19 in country',
    'gvimpc19': 'To what extent trust the government to deal with the impact of COVID-19 in country',
    'gvconc19': 'COVID-19 is result of deliberate and concerted efforts of some government or organisation',
    ...
    'getavc19': 'Whether respondent will get vaccinated against COVID-19 if approved by national regulatory authority in country',
    'getnvc19': 'Whether respondent would get vaccinated against COVID-19 if approved by national regulatory authority in country',
...
# meaningful we gonna be using (maybe)
# + for high value = positive answer; x for numeric variable
vars_to_use = [
    'cntry',    # categorical - group var
    # 'anweight', #
    'netusoft', # 7 8 9 x
    'ppltrst',  # 77 88 99 +
    'pplfair',  # 77 88 99 +
    ...
    'trstun',   # 77 88 99 +
    'trstsci',  # 77 88 99 +
    'vote',     # 7 8 9 (1 yes, 2 no, 3 can't) # clust
    # 'pstplonl', # 7 8 9 (1 yes)
    'lrscale',  # 77 88 99 (0 left, 10 right)
    'stflife',  # 77 88 99 + # pcs
    'stfeco',   # 77 88 99 + # clust
    'stfgov',   # 77 88 99 + # clust
    # 'imwbcnt',  # 77 88 99 +
    'happy',    # 77 88 99 + # pca
    'sclmeet',  # 77 88 99 + # pca
    # 'dscrgrp',  # 7 8 9 (1 yes)
    'ctzcntr',  # 7 8 9 (1 yes)
    # 'brncntr',  # 7 8 9 (1 yes)
    #'fairelcc', # 77 88 99 + 
    # 'viepolc',  # 77 88 99 +
    'accalaw',  # 77 88 99 - (high value = nazi) # clust
    'hhmmb',    # 77 88 99 x # clust
    'gndr',     # 9 (1 male, 2 female)
    'agea',     # 999 x
    'domicil',  # 7 8 9 (1 big city, 5 remote farm) # clust
    # 'eisced',   # 55 77 88 99 (0 not harmonizable, 1 unschooled, 7 big-brain)
    'eduyrs',   # 77 88 99 x
    'mnactic',  # 66 77 88 99 (nominal, to be encoded)
    # 'pdjobev',  # 6 7 8 9 (1 yes)
    # 'emplrel',  # 6 7 8 9 (nominal, to be encoded)
    # 'mcmsinf',  # 77 88 99 + (DOUBLE CHECK)
    'hhlipnt',  # 6 7 8 9 (1 yes) # clust
    'stfmjob',  # 66 77 88 99 +
    'secgrdec', # 7 8 9 (1 conspirationist, 10 npc) # dependent var
    'scidecpb', # 7 8 9 (1 conspirationist, 10 npc) # dependent var
    # 'gvhanc19',  # 77 88 99 +
    'ipcrtiv', # 7 8 9 -
    'imprich',
    'ipeqopt',
...
list_binary_vars = ['pstplonl', 'dscrgrp', 'ctzcntr','brncntr', 'gndr', 'pdjobev', 'hhlipnt'] # gender: 1=M, 0=F